{- Copy paste from Gabriel's slide https://github.com/Gabriel439/slides/blob/master/dhall-intro/dhall-intro.md#a-secure-web-server -}
...
import           Dhall.Core                 (Directory (..), File (..),
                                             FilePrefix (..), Import (..),
